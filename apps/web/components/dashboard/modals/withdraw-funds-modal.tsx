      ...
      <DialogContent className="border-white/10 bg-black/90 text-white shadow-2xl backdrop-blur w-full max-w-[360px] p-6 rounded-2xl [&>button]:text-white [&>button]:hover:text-white [&>button]:hover:bg-white/20 [&>button]:opacity-100">
        <DialogHeader className="space-y-3">
          ...
          <DialogDescription className="text-gray-400 text-sm leading-relaxed">
            Remove funds back to your unified balance. This operation is gasless and instant.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-5 py-2">
            ...
            {currentParticipant && (
              <div className="p-4 bg-white/5 border border-white/10 rounded-2xl">
                <p className="text-[10px] uppercase tracking-wider text-gray-500 font-medium mb-1">Available to Withdraw</p>
